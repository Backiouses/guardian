	...
	public void DoAction()
	{
		...
		case 3:
		{
			...
			case 8:
			{
				...
				{
					FengGameManagerMKII.StringVariables[key3] = (string)FengGameManagerMKII.StringVariables[key3] + text3;
				}
				break;
			}
			case 9:
			{
				...
				string text = (string)FengGameManagerMKII.StringVariables[key3];
				FengGameManagerMKII.StringVariables[key3] = text.Replace(parameters[1].ReturnString(null), parameters[2].ReturnString(null));
				break;
			}
			}
			break;
		...
		case 7:
		{
			...
			case 0:
				...
				{
					HERO obj = (HERO)FengGameManagerMKII.HeroHash[photonPlayer.Id];
					obj.MarkDead();
		...
		case 8:
			...
			case 3:
			{
				...
				tITAN2.currentHealth = parameters[1].ReturnInt(null);
