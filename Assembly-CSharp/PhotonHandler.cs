...
internal class PhotonHandler : Photon.MonoBehaviour, IPhotonPeerListener
{
	...
	internal IEnumerator PingAvailableRegionsCoroutine(bool connectToBest)
	{
		...
		while (PhotonNetwork.networkingPeer.AvailableRegions == null)
		{
			...
			Debug.Log("Waiting for AvailableRegions. State: " + PhotonNetwork.connectionStateDetailed.ToString() + " Server: " + PhotonNetwork.Server.ToString() + " PhotonNetwork.networkingPeer.AvailableRegions " + (PhotonNetwork.networkingPeer.AvailableRegions != null));
		...
		Debug.Log("Found best region: " + bestRegion.Code.ToString() + " ping: " + bestRegion.Ping + ". Calling ConnectToRegionMaster() is: " + connectToBest);
		if (connectToBest)
		{
