...
public class iTween : MonoBehaviour
{
	...
	public static void LookTo(GameObject target, Hashtable args)
	{
		...
		{
			Transform obj = (Transform)args["looktarget"];
			Hashtable hashtable = args;
			float x = obj.position.x;
			float y = obj.position.y;
			hashtable["position"] = new Vector3(x, y, obj.position.z);
			Hashtable hashtable2 = args;
			float x2 = obj.eulerAngles.x;
			float y2 = obj.eulerAngles.y;
			hashtable2["rotation"] = new Vector3(x2, y2, obj.eulerAngles.z);
		}
		args["type"] = "look";
		args["method"] = "to";
		Launch(target, args);
	...
	public static void MoveTo(GameObject target, Hashtable args)
	{
		...
		{
			Transform obj = (Transform)args["position"];
			Hashtable hashtable = args;
			float x = obj.position.x;
			float y = obj.position.y;
			hashtable["position"] = new Vector3(x, y, obj.position.z);
			...
			float x3 = obj.localScale.x;
			float y3 = obj.localScale.y;
			hashtable3["scale"] = new Vector3(x3, y3, obj.localScale.z);
		}
		args["type"] = "move";
		args["method"] = "to";
		Launch(target, args);
	...
	public static void MoveFrom(GameObject target, Hashtable args)
	{
		...
		{
			Vector3 vector;
			Vector3 vector2 = (flag ? (vector = target.transform.localPosition) : (vector = target.transform.position));
	...
	public static void ScaleTo(GameObject target, Hashtable args)
	{
		...
		{
			Transform obj = (Transform)args["scale"];
			Hashtable hashtable = args;
			float x = obj.position.x;
			float y = obj.position.y;
			hashtable["position"] = new Vector3(x, y, obj.position.z);
	...
	public static void RotateTo(GameObject target, Hashtable args)
	{
		...
		{
			Transform obj = (Transform)args["rotation"];
			Hashtable hashtable = args;
			float x = obj.position.x;
			float y = obj.position.y;
			hashtable["position"] = new Vector3(x, y, obj.position.z);
	...
	{
		args = CleanArgs(args);
		bool num = ((!args.Contains("islocal")) ? Defaults.isLocal : ((bool)args["islocal"]));
		Vector3 vector;
		Vector3 vector2 = (num ? (vector = target.transform.localEulerAngles) : (vector = target.transform.eulerAngles));
	...
	public static void RotateUpdate(GameObject target, Hashtable args)
	{
		...
		bool num2 = ((!args.Contains("islocal")) ? Defaults.isLocal : ((bool)args["islocal"]));
		if (num2)
		{
	...
	public static void CameraFadeDepth(int depth)
	{
		if ((bool)cameraFade)
		{
			Transform obj = cameraFade.transform;
			float x = cameraFade.transform.position.x;
			obj.position = new Vector3(x, cameraFade.transform.position.y, depth);
		}
	}
