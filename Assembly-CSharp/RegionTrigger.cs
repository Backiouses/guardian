...
public class RegionTrigger : MonoBehaviour
{
	...
	private void OnTriggerEnter(Collider other)
	{
		...
		else
		{
			...
			if (component2 != null)
			{
				string key2 = (string)FengGameManagerMKII.RCVariableNames["OnTitanEnterRegion[" + myName + "]"];
				if (FengGameManagerMKII.TitanVariables.ContainsKey(key2))
				{
					FengGameManagerMKII.TitanVariables[key2] = component2;
				}
				else
				{
					FengGameManagerMKII.TitanVariables.Add(key2, component2);
				}
	...
	private void OnTriggerExit(Collider other)
	{
		...
		else
		{
			...
			if (component2 != null)
			{
				string key2 = (string)FengGameManagerMKII.RCVariableNames["OnTitanLeaveRegion[" + myName + "]"];
				if (FengGameManagerMKII.TitanVariables.ContainsKey(key2))
				{
					FengGameManagerMKII.TitanVariables[key2] = component2;
				}
