...
public class Bomb : Photon.MonoBehaviour
{
	...
	public void Awake()
	{
		...
		else
		{
			...
			float b2 = GExtensions.AsFloat(owner.customProperties[PhotonPlayerProperty.RCBombB]);
			GetComponentInChildren<ParticleSystem>().startColor = new Color(r2, g2, b2, 1f);
		}
	}
