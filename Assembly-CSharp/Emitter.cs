...
public class Emitter
{
	...
	public Vector3 GetEmitRotation(EffectNode node)
	{
		...
		if (Layer.IsRandomDir)
		{
			...
			Quaternion quaternion2 = Quaternion.Euler(0f, UnityEngine.Random.Range(0, 360), 0f);
	...
	public void SetEmitPosition(EffectNode node)
	{
		...
		else if (Layer.EmitType == 2)
		{
			...
			vector = Quaternion.Euler(UnityEngine.Random.Range(0, 360), UnityEngine.Random.Range(0, 360), UnityEngine.Random.Range(0, 360)) * vector2 + vector;
		}
